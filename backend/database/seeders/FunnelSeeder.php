    ...
    private function seedContent(): void
    {
        $blocks = [
            ...
            'funnel.hero' => [
                ...
                'title' => 'Не ти ли писна от пластмасата в банята ти... ИМА И ДРУГ НАЧИН!',
                'body' => 'Miswak е естествена пръчица от Salvadora persica за почистване на зъбите, която можеш да използваш без паста и без мивка - изцяло натурална и биоразградима, със същата сила да гарантира блестящата ти усмивка!',
            ...
            'funnel.intro' => [
                'title' => 'Тайната зад Miswak - разкрита',
                'paragraphs' => [
                ...
                // No separate heading above the checklist — the paragraph
                // above already introduces it (ends with a colon).
                'benefits_title' => null,
                'benefits' => [
                    [
            ...
            'funnel.science' => [
                ...
                'cards' => [
                    ...
                    [
                        ...
                        'body' => 'Проучване от 2025 г. показва, че Miswak-ът има изразено антибактериално и антибиофилмново действие. Той може да подпомогне ограничаването на кариесогенните бактерии и натрупването на зъбна плака, като в редица проучвания резултатите му са сравними с конвенционални средства за орална хигиена.',
                        'source_url' => 'https://pubmed.ncbi.nlm.nih.gov/40475057/',
                        'source_label' => 'ВИЖ НАУЧНИЯ ИЗТОЧНИК ↗',
                    ],
                    [
                        'title' => 'Избелващи свойства',
                        'body' => 'Научният преглед посочва избелващия потенциал на Miswak-а, свързан включително със съдържащата се в него силика, която действа като естествен абразив. В лабораторно изследване Miswak паста с 0,4 – 0,5% екстракт постига средно промяна от около два нюанса, с ефект, сравним с използваната избелваща паста за зъби.',
