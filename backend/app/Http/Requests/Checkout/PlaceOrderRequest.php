...
class PlaceOrderRequest extends FormRequest
{
    ...
    {
        // Validated against currently-enabled methods (see
        // PaymentService::availablePaymentMethods()), not just any
        // PaymentMethod case — a disabled method must fail here with a
