    ...
    private function seedContent(): void
    {
        $blocks = [
            ...
            'funnel.why' => [
                ...
                'cards' => [
                    [
                        ...
                        'text' => 'Не ти трябва вода. Не ти трябва паста. Не ти трябва мивка. Използвай го в офиса, в колата или по време на път.',
                    ],
                    [
                        'icon' => 'tooth',
                        'title' => 'Допълва ежедневната грижа',
                        'text' => 'Miswak не заменя обичайната ти четка за зъби. Той е естествен помощник през деня — свеж дъх и чистота, когато си извън дома.',
                    ],
                    [
                        'icon' => 'globe',
                        'title' => 'Малък навик. Голяма разлика.',
                        'text' => 'Всяка година се изхвърлят милиарди пластмасови четки за зъби, които остават в природата десетилетия. Miswak се връща обратно в нея.',
                    ],
                ],
            ],
            'funnel.history' => [
            ...
            'funnel.final_cta' => [
                ...
                // delivery and "с карта" reflects that card is currently
