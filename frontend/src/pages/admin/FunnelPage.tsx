...
function HeroForm({ initial, onSaved }: SectionFormWrapperProps<FunnelHeroContent>) {
  return (
...
function IntroForm({ initial, onSaved }: SectionFormWrapperProps<FunnelIntroContent>) {
  return (
...
function WhyForm({ initial, onSaved }: SectionFormWrapperProps<FunnelWhyContent>) {
  return (
...
function ComparisonForm({ initial, onSaved }: SectionFormWrapperProps<FunnelComparisonContent>) {
  return (
...
function HistoryForm({ initial, onSaved }: SectionFormWrapperProps<FunnelHistoryContent>) {
  return (
...
function FeaturesForm({ initial, onSaved }: SectionFormWrapperProps<FunnelFeaturesContent>) {
  return (
...
function NaturalEcoForm({ initial, onSaved }: SectionFormWrapperProps<FunnelNaturalEcoContent>) {
  return (
...
function ScienceForm({ initial, onSaved }: SectionFormWrapperProps<FunnelScienceContent>) {
  return (
...
function AwarenessForm({ initial, onSaved }: SectionFormWrapperProps<FunnelAwarenessContent>) {
  return (
...
function PositioningForm({ initial, onSaved }: SectionFormWrapperProps<FunnelPositioningContent>) {
  return (
...
function FinalCtaForm({ initial, onSaved }: SectionFormWrapperProps<FunnelFinalCtaContent>) {
  return (
...
function FaqForm({ initial, onSaved }: SectionFormWrapperProps<FunnelFaqContent>) {
  return (
