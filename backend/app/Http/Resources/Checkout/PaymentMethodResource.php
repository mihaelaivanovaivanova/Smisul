...
/**
 * Wraps an array{method: PaymentMethod, available: bool, fee: float} —
 * `available` reflects the current shipping carrier (see
 ...
 * is selected. `fee` comes pre-resolved from PaymentService::feeFor() (admin
 * override or hardcoded default) rather than being computed here, since
 * that resolution needs a service the caller already has.
 */
class PaymentMethodResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            // See PaymentService::feeFor() - zero for every method except
