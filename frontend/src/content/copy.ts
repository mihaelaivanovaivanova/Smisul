...
export const funnelCheckout = {
  ...
  paragraphs: [
    'Направи първата крачка към по-естествена ежедневна грижа — у дома, в офиса и навсякъде с теб.',
    'Избери пакет от 3, 5 или 10 броя. Започни спокойно или се запаси за по-дълго — повече Miswak, повече удобство и по-добра стойност във всяка поръчка.',
  ],
